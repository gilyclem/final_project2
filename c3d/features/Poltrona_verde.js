...
Feature.inherits(Poltrona_verde, Feature);

function Poltrona_verde(feature) {
	Feature.call(this, feature);
}

Poltrona_verde.prototype.style = {
			    			prefix: "fa",
	    					icon: "minus",
	    					zIndex: 3
						};

Poltrona_verde.prototype.in_graph = true;

Poltrona_verde.prototype.in_2D_map = false;

Poltrona_verde.prototype.get3DModel = function() {
	...
	poltrona.scale.set(0.6,0.6,0.6);
	return poltrona;
};

module.exports = Poltrona_verde;
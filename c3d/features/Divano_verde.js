...
Feature.inherits(Divano_verde, Feature);

function Divano_verde(feature) {
	Feature.call(this, feature);
}

Divano_verde.prototype.style = {
			    			prefix: "fa",
	    					icon: "minus",
	    					zIndex: 3
						};

Divano_verde.prototype.in_graph = true;

Divano_verde.prototype.in_2D_map = false;

Divano_verde.prototype.get3DModel = function() {
	var divano = new THREE.Object3D();
	//Materiali
	var tessuto = new THREE.MeshPhongMaterial( {color: 0xdcdcdc} );
	var texture = THREE.ImageUtils.loadTexture("assets/textures/tessuto_verde.jpg");
	tessuto.map = texture;

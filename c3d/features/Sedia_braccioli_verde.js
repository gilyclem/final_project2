...
Feature.inherits(Sedia_braccioli_verde, Feature);

function Sedia_braccioli_verde(feature) {
	Feature.call(this, feature);
}

Sedia_braccioli_verde.prototype.style = {
			    			prefix: "fa",
	    					icon: "minus",
	    					zIndex: 3
						};

Sedia_braccioli_verde.prototype.in_graph = true;

Sedia_braccioli_verde.prototype.in_2D_map = false;

Sedia_braccioli_verde.prototype.get3DModel = function() {
	...
	var texture2 = THREE.ImageUtils.loadTexture("assets/textures/tessuto_verde.jpg");
	...
	sedia.scale.set(0.5,0.5,0.5);
	return sedia;
};

module.exports = Sedia_braccioli_verde;
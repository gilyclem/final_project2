...
Feature.inherits(Poltrona_grigia, Feature);

function Poltrona_grigia(feature) {
	Feature.call(this, feature);
}

Poltrona_grigia.prototype.style = {
			    			prefix: "fa",
	    					icon: "minus",
	    					zIndex: 3
						};

Poltrona_grigia.prototype.in_graph = true;

Poltrona_grigia.prototype.in_2D_map = false;

Poltrona_grigia.prototype.get3DModel = function() {
	var poltrona = new THREE.Object3D();

	//Materiali

	var legno = new THREE.MeshBasicMaterial( {color: 0x0000dc} );
...
module.exports = Poltrona_grigia;
...
var inputPaths = {
	config: __dirname + '/../json_input/progetto_finale/config.json',
	architecture: __dirname + '/../json_input/progetto_finale/architecture.json',
	furniture: __dirname + '/../json_input/progetto_finale/furnitures.json'
};
